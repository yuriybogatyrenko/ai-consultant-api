...
export class Init1722519072776 implements MigrationInterface {
    name = 'Init1722519072776'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contact_thread" ("thread_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "gpt_thread_id" character varying, "status" "public"."contact_thread_status_enum" NOT NULL DEFAULT 'active', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "contactContactId" uuid, "userId" uuid, CONSTRAINT "REL_bd1c8052e8a4b2d105b388f579" UNIQUE ("contactContactId"), CONSTRAINT "PK_f7a68779bf866d1f37c4858f200" PRIMARY KEY ("thread_id"))`);
        await queryRunner.query(`CREATE TABLE "contact_message" ("message_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "content" text NOT NULL, "platoform_message_id" character varying, "platform" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "threadThreadId" uuid, "contactContactId" uuid, CONSTRAINT "PK_459d31fe452d1adb97cb3bf2b61" PRIMARY KEY ("message_id"))`);
        await queryRunner.query(`CREATE TABLE "contact" ("contact_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying, "platform" character varying NOT NULL, "platform_user_id" character varying, "platform_username" character varying, "language_code" character varying, "phone_number" character varying, "email" character varying, "accountAccountId" uuid, CONSTRAINT "UQ_3bdccdb674dfc3670951d0d930d" UNIQUE ("platform_user_id"), CONSTRAINT "PK_b77c91f220387c3c90df787bce5" PRIMARY KEY ("contact_id"))`);
        await queryRunner.query(`CREATE TABLE "platform_instagram_setting" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "access_token" character varying NOT NULL, "instagram_user_id" character varying NOT NULL, "instagram_username" character varying NOT NULL, "token_type" character varying NOT NULL, "expires_in" integer NOT NULL, "gpt_assistant_id" character varying, "is_active" boolean NOT NULL DEFAULT false, "connected_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "accountAccountId" uuid, CONSTRAINT "REL_8af95724823769a4a091962358" UNIQUE ("accountAccountId"), CONSTRAINT "PK_ec15cb67002fe69cac2e1b047a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "platform_telegram_setting" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "access_token" character varying NOT NULL, "bot_username" character varying NOT NULL, "gpt_assistant_id" character varying, "is_active" boolean NOT NULL DEFAULT false, "connected_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "account_id" uuid, CONSTRAINT "REL_5ba1b9cdf02a6db8b9b5361f8c" UNIQUE ("account_id"), CONSTRAINT "PK_3688b4166af32a716129576c8cb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "platform_whats_app_setting" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "access_token" character varying NOT NULL, "phone_number_id" character varying NOT NULL, "gpt_assistant_id" character varying, "is_active" boolean NOT NULL DEFAULT false, "connected_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_919942f9879840ebf686add1dec" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "account" ("account_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying, "gpt_api_key" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "ownerId" uuid, "telegramSettingsId" uuid, "whatsappSettingsId" uuid, "instagramSettingsId" uuid, CONSTRAINT "REL_df894821d0ab794e0706063f78" UNIQUE ("telegramSettingsId"), CONSTRAINT "REL_78b2b2ff5c9c86b7e14eada520" UNIQUE ("whatsappSettingsId"), CONSTRAINT "REL_8593bfff73ad9f140a7107f153" UNIQUE ("instagramSettingsId"), CONSTRAINT "PK_ea08b54a9d7322975ffc57fc612" PRIMARY KEY ("account_id"))`);
        await queryRunner.query(`CREATE TYPE "public"."user_entity_user_type_enum" AS ENUM('admin', 'user')`);
        await queryRunner.query(`CREATE TABLE "user_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "password" character varying NOT NULL, "user_type" "public"."user_entity_user_type_enum" NOT NULL DEFAULT 'user', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_415c35b9b3b6fe45a3b065030f5" UNIQUE ("email"), CONSTRAINT "PK_b54f8ea623b17094db7667d8206" PRIMARY KEY ("id"))`);
